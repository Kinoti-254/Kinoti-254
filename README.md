...
- Built a command-line contact manager with persistent storage
- Allows users to add, search, and list contacts
- Uses JSON for data storage
- Structured into modular components for scalability

👉 Tech: Python, JSON  
👉 Concepts: file handling, modular programming, CRUD operations  

🔗 Repo: https://github.com/Kinoti-254/contact_book

---

### 📌 Bill Splitter (Python)
- Built a tool to split bills among multiple people
- Calculates each person’s share based on input values
- Handles basic validation and edge cases

👉 Tech: Python  
👉 Concepts: arithmetic logic, user input handling, problem-solving  
